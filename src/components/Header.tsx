...
import {searchPokemonByName} from "@/data/helpers/pokemon.helpers";
            ...
            <form onSubmit={handleSubmit} className="flex-1">
                <div className="relative">
                    <input
                        ...
                        className="pl-10 pr-4 py-2 bg-zinc-800 text-white placeholder-zinc-400 rounded-full focus:outline-none focus:ring-2 focus:ring-zinc-700"
                    />
                    <Search
